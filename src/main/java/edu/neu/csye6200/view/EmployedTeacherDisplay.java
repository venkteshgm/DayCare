 ...
 */
public class EmployedTeacherDisplay extends javax.swing.JFrame {

    /**
     * Creates new form EmployedTeacherDisplay
     */
    ...
    public void addRowToJTable1( List<Teacher> list)
    {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployedTeacherDisplay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployedTeacherDisplay().setVisible(true);
            }
        });
    }
