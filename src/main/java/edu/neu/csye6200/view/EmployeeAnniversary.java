 ...
 */
public class EmployeeAnniversary extends javax.swing.JFrame {

    /**
     * Creates new form EmployeeAnniversary
     */
    public EmployeeAnniversary() {
        initComponents();
        List<Teacher> list = TeacherService.getTeacherAnniversary();
        addRowToJTable(list);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeAnniversary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployeeAnniversary().setVisible(true);
            }
        });
    }
